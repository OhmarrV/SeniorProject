...
public class DatabaseHandler
{
    ...
    public DatabaseHandler(string databasePath)
    {
        ...
        Console.WriteLine($"Using database: C:\"C:\\SeniorProject\\VelocifyUsers.db\".db");
        connection = new SQLiteConnection($"Data Source=\"C:\\SeniorProject\\VelocifyUsers.db\";Version=3;");
        connection.Open();
